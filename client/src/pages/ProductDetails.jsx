    ...
    return product && (
        <div className="mt-16">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                                <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} className="w-3.5 md:w-4"/>
                        ))}
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={()=> {addToCart(product._id); navigate("/cart")}} className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-dull-primary transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 mt-6 gap-3 md:gap-6 lg:grid-cols-5 w-full">
